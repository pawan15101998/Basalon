...
//     //   data['event_date'] =
//     //       this.eventDate!.map((v) => v.toJson()).toList();
//     // }
//     data['marker_price'] = this.markerPrice;
//     data['marker_date'] = this.markerDate;
//     data['show_featured'] = this.showFeatured;
...
//   EventDate({this.calanderId, this.startTime, this.endTime, this.startDate, this.date});

//   EventDate.fromJson(Map<String, dynamic> json) {
//     calanderId = json['calendar_id'];
//     startTime = json['start_time'];
...
//   Map<String, dynamic> toJson() {
//     final Map<String, dynamic> data = new Map<String, dynamic>();
//     data['calendar_id'] = this.calanderId;
//     data['start_time'] = this.startTime;
...
class Data {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['show_featured'] = this.showFeatured;
    if (this.eventDate != null) {
      data['event_date'] = this.eventDate!.map((v) => v.toJson()).toList();
    }
    data['share_link'] = this.shareLink;
    return data;
  }
